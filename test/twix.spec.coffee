...
thatDay = (start, end) ->
  if start
    moment("1982-5-25 #{start}").twix "1982-5-25 #{end}"
  else
    moment("1982-5-25").twix "1982-5-25", true

describe "plugin", ->
  describe "static constructor", ->
    it "is the same as instantiating via the contructor", ->
      assertEqual "function", typeof moment.twix
      assertTwixEqual new Twix("1982-5-25", "1983-5-25", true), moment.twix("1982-5-25", "1983-5-25", true)

  describe "create from a member", ->
    it "is the same as instantiating via the contructor", ->
      assertEqual "function", typeof(moment().twix)
      assertTwixEqual new Twix("1982-5-25", "1983-5-25", true), moment("1982-5-25").twix("1983-5-25", true)
  ...
  describe "duration.afterMoment()", ->
    ...
    it "can use text", ->
      ...
      assertTwixEqual new Twix("1982-5-25", "1982-5-27"), twix
  ...
  describe "duration.beforeMoment()", ->
    ...
    it "can use text", ->
      ...
      assertTwixEqual new Twix("1982-5-23", "1982-5-25"), twix
...
describe "isSame()", ->
  ...
  describe "year", ->
    it "returns true if they're the same year", ->
      assertEqual true, moment("1982-5-25").twix("1982-10-14").isSame "year"

    it "returns false if they're different years", ->
      assertEqual false, moment("1982-5-25").twix("1983-10-14").isSame "year"

  describe "day", ->

    it "returns true if they're the same day", ->
      assertEqual true, moment("1982-5-25 5:30 AM").twix("1982-5-25 7:30 PM").isSame "day"

    it "returns false if they're different days day", ->
      assertEqual false, moment("1982-5-25 5:30 AM").twix("1982-5-26 7:30 PM").isSame "day"

    it "returns true they're in different UTC days but the same local days", ->
      assertEqual true, moment("1982-5-25 5:30 AM").twix("1982-5-25 11:30 PM").isSame "day"
...
describe "humanizeLength()", ->
  describe "all-day events", ->
    it "formats single-day correctly", ->
      assertEqual("all day", new Twix("1982-5-25", "1982-5-25", true).humanizeLength())

    it "formats multiday correctly", ->
      assertEqual("3 days", new Twix("1982-5-25", "1982-5-27", true).humanizeLength())
  ...
  describe "non-all-day events", ->
    ...
    it "formats multiday correctly", ->
      assertEqual("2 days", new Twix("1982-5-25", "1982-5-27").humanizeLength())
...
describe "overlaps()", ->
  ...
  describe "one all-day event", ->
    it "returns true for a partially later event", ->
      assertOverlap thatDay(), new Twix("1982-5-25 20:00", "1982-5-26 5:00")

    it "returns true for a partially earlier event", ->
      assertOverlap thatDay(), new Twix("1982-5-24 20:00", "1982-5-25 7:00")

    it "returns true for an engulfed event", ->
      assertOverlap thatDay(), someTime

    it "returns true for an engulfing event", ->
      assertOverlap thatDay(), new Twix("1982-5-24 20:00", "1982-5-26 5:00")
      
    it "returns true for an event which starts on the same day", ->
      assertOverlap thatDay(), new Twix("1982-5-25", "1982-5-27");
      
    it "returns true for an event which ends on the same day", ->
      assertOverlap thatDay(), new Twix("1982-5-23", "1982-5-25", true);

  describe "two all-day events", ->
    it "returns false for a later event", ->
      assertNoOverlap someDays, new Twix("1982-5-26", "1982-5-27", true)

    it "returns false for an earlier event", ->
      assertNoOverlap someDays, new Twix("1982-5-22", "1982-5-23", true)

    it "returns true for a partially later event", ->
      assertOverlap someDays, new Twix("1982-5-24", "1982-5-26", true)

    it "returns true for a partially earlier event", ->
      assertOverlap someDays, new Twix("1982-5-22", "1982-5-24", true)

    it "returns true for an engulfed event", ->
      assertOverlap someDays, new Twix("1982-5-25", "1982-5-25", true)

    it "returns true for an engulfing event", ->
      assertOverlap someDays, new Twix("1982-5-22", "1982-5-28", true)
...
describe "engulfs()", ->
  ...
  describe "one all-day event", ->
    it "returns true for a partially later event", ->
      assertNotEngulfing thatDay(), new Twix("1982-5-25 20:00", "1982-5-26 5:00")

    it "returns true for a partially earlier event", ->
      assertNotEngulfing thatDay(), new Twix("1982-5-24", "20:00", "1982-5-25 7:00")

    it "returns true for an engulfed event", ->
      assertEngulfing thatDay(), someTime

    it "returns true for an engulfing event", ->
      assertNotEngulfing thatDay(), new Twix("1982-5-24 20:00", "1982-5-26 5:00")

  describe "two all-day events", ->
    it "returns false for a later event", ->
      assertNotEngulfing someDays, new Twix("1982-5-26", "1982-5-27", true)

    it "returns false for an earlier event", ->
      assertNotEngulfing someDays, new Twix("1982-5-22", "1982-5-23", true)

    it "returns true for a partially later event", ->
      assertNotEngulfing someDays, new Twix("1982-5-24", "1982-5-26", true)

    it "returns true for a partially earlier event", ->
      assertNotEngulfing someDays, new Twix("1982-5-22", "1982-5-24", true)

    it "returns true for an engulfed event", ->
      assertEngulfing someDays, new Twix("1982-5-25", "1982-5-25", true)
