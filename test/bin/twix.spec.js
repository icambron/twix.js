  ...
  test = function(moment, Twix) {
    ...
    describe("humanizeLength()", function() {
      describe("all-day ranges", function() {
        ...
        it("formats multiday correctly", function() {
          return assertEqual("3 days", new Twix("1982-05-25", "1982-05-27", true).humanizeLength());
        });
        return it("allows you to override the all-day text", function() {
          return assertEqual("dude", new Twix("1982-05-25", "1982-05-25", true).humanizeLength({
            allDay: 'dude'
          }));
        });
      });
