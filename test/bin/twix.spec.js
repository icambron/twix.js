...
(function() {
  var Twix, assertEqual, assertTwixEqual, moment, thatDay, thisYear, tomorrow, yesterday;
  ...
  describe("past()", function() {
    describe("all-day events", function() {
      ...
      it("returns false for today", function() {
        return assertEqual(false, new Twix(moment().startOf('day'), moment().startOf('day'), true).past());
      });
